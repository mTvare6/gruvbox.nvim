...
local plugins = lush(function()
  return {
    ...
    TelescopeBorder {base.GruvboxBg2},
    TelescopePromptBorder {base.GruvboxBg2},
    TelescopeResultsBorder {base.GruvboxBg2},
    TelescopePreviewBorder {base.GruvboxBg2},
    TelescopeMatching {base.GruvboxBlue},
    TelescopePromptPrefix {base.GruvboxRed},
    TelescopePrompt {base.GruvboxFg1},
    -- lspsaga.nvim
